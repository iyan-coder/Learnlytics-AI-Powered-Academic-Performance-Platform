...
from student_performance_indicator.utils.main_utils.utils import save_numpy_array_data, save_object
...
class DataTransformation:
    def __init__(self, data_validation_artifact: DataValidationArtifact, data_transformation_config: DataTransformationConfig):
        try:
            ...
            logger.error("Error occurred during DataTransformation initialization", exc_info=True)
    ...
    def get_data_transformer_object(self) -> ColumnTransformer:
        ...
        try:
            ...
            numerical_columns = feature_train_df.select_dtypes(include=['number']).columns.tolist()
            categorical_columns = feature_test_df.select_dtypes(include=['object', 'category']).columns.tolist()
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        try:
            ...
            # Concatenate target with features
